                    ...
                    <ul className={`navigation-menu justify-start ${navlight ? 'nav-light' : ''}`}>
                        ...
                        <li className={`has-submenu parent-parent-menu-item ${['/grid','/grid-sidebar','/list','/list-sidebar','/youtube-listing','/video-listing','/course-detail','/course-detail-two'].includes(manu)? 'active' :''}`}>
                            ...
                            <ul className={`submenu ${['/cours-item','/grid-item','/list-item','/video-item','/courses-item'].includes(subManu) ? 'open' : ''}`}>
                                ...
                                <li className={`has-submenu parent-menu-item ${['/list','/list-sidebar'].includes(manu) ? 'active' :''}`}><Link to="#" onClick={()=>setSubManu(subManu === '/list-item' ? '' : '/list-item')}> List Courses </Link><span className="submenu-arrow"></span>
                                ...
                                <li className={`has-submenu parent-menu-item ${['/course-detail','/course-detail-two'].includes(manu) ? 'active' :''}`}><Link to="#" onClick={()=>setSubManu(subManu === '/courses-item' ? '' : '/courses-item')}> Courses Detail</Link><span className="submenu-arrow"></span>
                                    <ul className={`submenu ${['/courses-item'].includes(subManu) ? 'open' : ''}`}>
                                        <li className={manu === '/course-detail' ? 'active' : ''}><Link to="/course-detail" className="sub-menu-item">Courses Detail</Link></li>
                                        <li className={manu === '/course-detail-two' ? 'active' : ''}><Link to="/course-detail-two" className="sub-menu-item">Courses Detail Two</Link></li>
                                    </ul>  
                                </li>
                            </ul>
                        </li>
