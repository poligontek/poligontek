...
import cta from '../../assets/images/bg/bg.png'
        ...
        <>
                ...
                <div className="container relative">
                    <div className="grid md:grid-cols-2 grid-cols-1 gap-6 items-center">
                        <div>
                            ...
                            <div className="mt-6">
                                <Link to="" className="h-12 px-6 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-violet-600 text-white">Cursos<i className="mdi mdi-arrow-right align-middle ms-1"></i></Link>          <Link to="" className="h-12 px-6 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-violet-600 text-white">Contacto<i className="mdi mdi-arrow-right align-middle ms-1"></i></Link>
                            </div>
            ...
            <section className="relative md:py-24 py-16">
                ...
                <div className="container-fluid relative overflow-hidden md:mt-24 mt-16">
                    <div className="bg-violet-600 md:pt-0 pt-16 bg-no-repeat bg-top bg-cover" style={{ backgroundImage: `url(${cta})` }}>
                        <div className="container relative">
                            <div className="grid md:grid-cols-12 grid-cols-1 gap-6 items-center">
                                ...
                                <div className="lg:col-span-4 md:col-span-5">
                                    <div className="relative">
                                        <img src={hero2} className="mx-auto relative z-2" alt="" />
